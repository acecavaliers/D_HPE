      ...
      <div class="relative overflow-x-auto border">
        <table class="w-full text-sm text-left text-gray-500 p-2 uppercase ">
            ...
            <tr v-for="(item, index) in records.data" :key="index" class="bg-white border-b hover:bg-gray-50">
                ...
                <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap">{{ item.illness_groups.name }}</th>
                <td class="px-6 py-4">
                ...
                <span class="isolate inline-flex">
                    <a href="#" class="mr-2 rounded-lg relative inline-flex px-3 py-3 text-xs text-gray-900 hover:bg-gray-400 hover:text-white focus:z-10"><font-awesome-icon icon="fa-solid fa-eye" class="h-5 w-5" /></a>
