        ...
        <table class="w-full text-sm text-left text-gray-500 p-2 uppercase ">
            ...
            <tr v-for="(item, index) in records.data" :key="index" class="bg-white border-b hover:bg-gray-50">
                ...
                <span class="isolate inline-flex">
                    <a @click="openLayout('child')" class="mr-2 rounded-lg relative inline-flex px-3 py-3 text-xs text-gray-900 hover:bg-gray-400 hover:text-white focus:z-10"><font-awesome-icon icon="fa-solid fa-eye" class="h-5 w-5" /></a>
