      ...
      <div class="grid items-end gap-6 mb-6">
        <div class="relative">
          <input
            ...
            placeholder=" "
          />
          <label for="name" class="absolute text-sm text-gray-700 duration-300 transform -translate-y-3 scale-80 top-1 z-10 origin-[0] bg-white px-2 peer-focus:px-2 peer-focus:text-blue-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-1 peer-focus:scale-80 peer-focus:-translate-y-3 start-1 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto">History Name</label>
        </div>
        ...
        <div id="app" class=" flex justify-start">
            <div class="mr-2">
                <label class="inline-flex items-center cursor-pointer">
                    ...
                    <span class="ms-3 text-sm font-medium text-gray-700">With Input</span>
                </label>
            </div>
            <div class="ml-2">
                <label class="inline-flex items-center cursor-pointer">
...
export default {
  ...
  methods: {
    ...
    submitPost() {
      axios.post('fh',{formdata:this.form})
        .then(response => {
