    ...
    <div class="transition-colors duration-300">
            <div class="container mx-auto p-4">
                <div class="bg-white shadow rounded-lg p-6">
                    <h1 class="text-md font-semibold text-gray-900">PART III: ASSESSMENT & RECOMMENDATION</h1>
                    <p class="text-sm text-gray-900 mb-6 bg-gray-200 p-2"><b>TO DMC LWC PHYSICIAN:</b> ENTER REQUIRED INFORMATION.</p>
                    <form>
