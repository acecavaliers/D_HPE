    ...
    <MasterLayout>
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
            <div class="flex items-center justify-between flex-column md:flex-row flex-wrap space-y-4 md:space-y-0 py-4 bg-white">
                ...
                <div class="px-5">
                    <div>
                        <button @click="showModal = true" class="bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600">Add Account</button>
                        <Modal :title="'Add Account'" :isVisible="showModal" @close="handleModalClose">
                            <AddAccount @formSubmitted="handleFormSubmitted"/>
                        </Modal>
                    </div>
                </div>
            </div>
...
import AddAccount from '@/Pages/Accounts/AddAccount.vue';
